...
const MASTER_DATA_ID="1K6BkioKmfd0u9TWUUqlQ3jyAj8wvlAsSUzA3OhVIkiY"
const STORE="M118"
...
function accIncentive(unitPrice:number){if(unitPrice<=599000)return 5000;if(unitPrice<=2000000)return 10000;if(unitPrice<=4000000)return 20000;if(unitPrice<=6000000)return 40000;return 80000}
